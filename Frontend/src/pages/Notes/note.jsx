...
const Note = ({ note, onClick, onDelete }) => {
  return (
    <div className="bg-gray-700 m-4 p-4 max-w-xl rounded-2xl min-h-52 flex flex-col justify-between transition-transform duration-200 hover:-translate-y-1">
      ...
      <div className="relative flex-1 overflow-auto scrollbar-thin scrollbar-track-gray-300">
        <div className="pr-1 text-white break-words whitespace-normal text-sm">{note.content}</div>
